...
import com.cy.store.model.User;
...
public class UserController extends BaseController {
    ...
    public BaseResponse<Void> reg(User user) {
    ...
    public BaseResponse<User> login(String phone, String password, HttpSession session) {
        ...
        return new BaseResponse<User>("用户登陆成功",true,data);
    }

    @RequestMapping("change_password")
    public BaseResponse<Void> changePassword(String oldPassword,
                                             String newPassword,
                                             HttpSession session) {
    ...
    public BaseResponse<User> getByUid(HttpSession session) {
        User data = userService.getByUid(getUidFromSession(session));
        return new BaseResponse<User>(OK,data);
    }

    @RequestMapping("change_info")
    public BaseResponse<Void> changeInfo(User user, HttpSession session) {
...
//      AVATAR_TYPE.add("image/jpg");//为啥不需要这个呢
    ...
    public BaseResponse<String> changeAvatar(HttpSession session,
                                             MultipartFile file) {
        /**
        ...
        return new BaseResponse<>(OK,avatar);
    }
}
